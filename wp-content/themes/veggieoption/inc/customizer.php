...
if ( ! function_exists( 'understrap_theme_customize_register' ) ) {
	...
	function understrap_theme_customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting('veggieoption_secondary_logo', array(
			'type' => 'theme_mod'
		));
		// Add a control to upload the hover logo
		$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'veggieoption_secondary_logo', array(
			'label' => 'Logo (Solid Header)',
			'section' => 'title_tagline', //this is the section where the custom-logo from WordPress is
			'settings' => 'veggieoption_secondary_logo',
